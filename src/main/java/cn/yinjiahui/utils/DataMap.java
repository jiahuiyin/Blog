...
public class DataMap {
    ...
    public static DataMap success() {
        ...
        dataMap.status = CodeType.SUCCESS_STATUS.getCode();
        return dataMap;
    }
    public static DataMap success(CodeType codeType) {
        DataMap dataMap = new DataMap();
        dataMap.status = codeType.getCode();
        return dataMap;
    }

    public static  DataMap fail(CodeType codeType) {
        DataMap dataMap = new DataMap();
        dataMap.status = codeType.getCode();
        dataMap.message =codeType.getMessage();
        return dataMap;
    }

    public DataMap setData(Object data) {
        this.data = data;
        return this;
    }
