...
var category="";
    ...
    function putInTagArticleInfo(data) {
        ...
        timeLine.append($('<div class="timeline-row">' +
            ...
            '</div>'));
        $.each(data['pageInfo']['list'],function (index,obj) {
            ...
            if(data['status'] == 103){
                ...
                $.each(data['data'], function (index, obj) {
                    categoriesComment.append($('<div class="category">' +
                        '<span><a class="categoryName">' + obj['categoryName'] + '</a><span class="categoryNum">(' + obj['categoryNum'] + ')</span></span>' +
                        '</div>'));
                });
